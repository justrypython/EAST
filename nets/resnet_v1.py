...
@slim.add_arg_scope
def bottleneck_v2(inputs, depth, depth_bottleneck, stride, rate=1,
               outputs_collections=None, scope=None):
    """Bottleneck residual unit variant with BN after convolutions.
    ...
    with tf.variable_scope(scope, 'bottleneck_v1', [inputs]) as sc:
        ...
        residual = resnet_utils.conv2d_same(inputs, depth_bottleneck, 3, stride=1,
                                            scope='conv1')
        residual = resnet_utils.conv2d_same(residual, depth_bottleneck, 3, stride,
                                            rate=rate, scope='conv2')
...
def resnet_v1_18(inputs,
    ...
    blocks = [
        resnet_utils.Block(
            'block1', bottleneck_v2, [(64, 64, 1)] + [(64, 64, 2)]),
        resnet_utils.Block(
            'block2', bottleneck_v2, [(128, 128, 1)] + [(128, 128, 2)]),
        resnet_utils.Block(
            'block3', bottleneck_v2, [(256, 256, 1)] + [(256, 256, 2)]),
        resnet_utils.Block(
            'block4', bottleneck_v2, [(512, 512, 1)] * 2)
    ]
...
resnet_v1_18.default_image_size = resnet_v2.default_image_size
